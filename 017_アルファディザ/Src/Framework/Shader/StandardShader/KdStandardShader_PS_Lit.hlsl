...
static const int originMatrix[8][8] =
{
	{ 0,  32, 16, 48,  8, 40, 24, 56 },
	{ 48,  8, 40, 24, 56,  0, 32, 16 },
	{ 16, 48,  0, 32, 24, 56,  8, 40 },
	{ 32, 16, 48,  0, 40, 24, 56,  8 },
	{ 8 , 40, 24, 56,  0, 32, 16, 48 },
	{ 56,  0, 32, 16, 48,  8, 40, 24 },
	{ 24, 56,  8, 40,  0, 32, 16, 48 },
	{ 40, 24, 56,  8, 32, 16, 48,  0 },
};
...
float4 main(VSOutput In) : SV_Target0
{
	...
	{
		// fmod: [%]余りを求める演算子
		// In:Pixelの情報　Pos:2D座標
		// 今から書こうとしているピクセルのx座標が200＝0
		// 今から書こうとしているピクセルのx座標が103＝3
//		int x = (int) fmod(In.Pos.x, 8);
//		int y = (int) fmod(In.Pos.y, 8);

//		float dither = originMatrix[y][x] / 57.0;
		...
		// 読み込んだ画像の色情報を所得
		float dither = g_ditherTex.Sample(g_ss,
		float2(tw * fmod(In.Pos.x, w), th * fmod(In.Pos.y, h))).r;
