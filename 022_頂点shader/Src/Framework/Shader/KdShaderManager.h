...
public:
	...
	struct cbAmbient
	{
		int m_windowEnable{ 0 };
		Math::Vector3 m_windowVal{ 0,0,0 };
	...
	void SetWindowEnable(const bool isWindow) { m_cb10_Ambient.Work().m_windowEnable = isWindow; }
	void SetWindowVal(const Math::Vector3& val) 
	{ 
		m_cb10_Ambient.Work().m_windowVal = val;
