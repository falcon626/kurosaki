...
void KdShaderManager::WriteCBConeLightEnabele(const bool _enable)
{
...
void KdShaderManager::WriteCBConeLight(const Math::Vector3& _pos, const float _range, const Math::Vector3& _dir, const float _angle, const Math::Vector3& _color)
{
